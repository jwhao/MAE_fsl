...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess):
        ...
        self.train = torchvision.datasets.ImageFolder(self.image_dir + '/train', transform=train_preprocess)
        self.val = torchvision.datasets.ImageFolder(self.image_dir + '/val', transform=test_preprocess)
        self.test = torchvision.datasets.ImageFolder(self.image_dir + '/val', transform=test_preprocess)
