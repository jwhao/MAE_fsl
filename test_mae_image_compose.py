...
parser.add_argument('--test_n_episode', default=10, type=int, help='number of episodes in meta val')
...
log_path = os.path.join(log_path,'save/{}_test_task-{}_shot-{}_mae_image_compose'.format(params.dataset,params.test_n_episode,params.n_shot))
